...
class FormValidator {
  ...
  static String? isNameValid({required String? value}) {
    if (value == null || value.trim().toString().isEmpty) {
      ...
      return "Name length less than twenty".tr;
    } else {
      return null;
    }
  }
  ...
  static String? isPineCodeValid({required String? value}) {
    if (value == null || value.trim().toString().isEmpty) {
      return "Please enter pin code".tr;
    } else if (value.trim().length < 6 || value.trim().length > 6) {
      return "Please enter valid pin code".tr;
  ...
  static String? isPasswordValid(
    ...
    if (value == null || value.trim().toString().isEmpty) {
      ...
      return "Password length greater than six".tr;
    } else if (value.trim().length > 12) {
      return "Password length less than twelve".tr;
