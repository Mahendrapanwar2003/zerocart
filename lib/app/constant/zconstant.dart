...
class Zconstant{
  ...
  static String imageSomethingWentWrong = "assets/something_went_wrong.png";
  static String imageNoDataFound = "assets/no_data_found.png";
  static String imageNoInternetConnection = "assets/no_internet_image.png";
